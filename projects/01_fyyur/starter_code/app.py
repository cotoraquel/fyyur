...
class Artist(db.Model):
    ...
    #DONE Define the relationship between Artist and Show models
...
class Show(db.Model):
    ...
    venue_id = db.Column(db.Integer, db.ForeignKey('venues.id'), nullable=False)
     ...
     # done Define the relationship between Show and Venue models
    venue = db.relationship('Venue', back_populates='shows')

    # done Define the relationship between Show and Artist models
